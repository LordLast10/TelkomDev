...
class EditProfile extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin/ubahprofile', $data);
    }
    public function edit()
    {
        ...
        if (!$this->validate($validate)) {
            ...
            return redirect()->to(base_url('admin/profile/edit'))->withInput()->with('errors', $errors);
        }
        ...
        return redirect()->to(base_url('admin/profile'))->with('success', 'Profile berhasil diubah');
    }
